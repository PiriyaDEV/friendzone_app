...
module.exports = function (app) {
  ...
  app.get(
    ...
    auth,
    controller.getEventCategorySummary
  );

  app.get("/api/analyst/getUserSummary", auth, controller.getUserSummary);

  app.get(
    "/api/analyst/getUserHistorySummary",
    auth,
    controller.getUserHistorySummary
  );

  app.get(
    "/api/analyst/getDiscountSummary",
    auth,
    controller.getDiscountSummary
  );

  app.get("/api/analyst/getReportSummary", auth, controller.getReportSummary);

  app.get(
    "/api/analyst/getReportTypeSummary",
    auth,
    controller.getReportTypeSummary
  );
};
