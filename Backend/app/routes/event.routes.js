...
module.exports = function (app) {
  ...
  app.post("/api/event/updateInterestEvent", auth,controller.updateInterestEvent);
  ...
  app.post(
    "/api/event/createParticipantReview" , auth,
  ...
  app.get(
    "/api/event/getEventGenderList/:event_id",auth,
    controller.getEventGenderList
  );

  app.get(
    "/api/event/getEventCategoryList/:event_id",auth,
    controller.getEventCategoryList
  );

  app.get("/api/event/getHostedEvent/:user_id", auth,controller.getHostedEvent);

  app.get("/api/event/getJoinedEvent/:user_id", auth,controller.getJoinedEvent);

  app.get(
    "/api/event/getRequestedEvent/:user_id",auth,
    controller.getRequestedEvent
  );

  app.get(
    "/api/event/getInterestedEvent/:user_id",auth,
    controller.getInterestedEvent
  );

  app.get(
    "/api/event/getEventParticipantList/:event_id",auth,
    controller.getEventParticipantList
  );

  app.get(
    "/api/event/getParticipantToReview",auth,
    controller.getParticipantToReview
  );

  app.get(
    "/api/event/getUserCateogryInterestEvent/:user_id",auth,
    controller.getUserCateogryInterestEvent
  );

  app.get(
    "/api/event/getEventByCategory/:user_id/:category_id",auth,
