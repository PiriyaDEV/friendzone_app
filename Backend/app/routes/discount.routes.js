...
module.exports = function (app) {
  ...
  app.post("/api/discount/uploadDiscountPic", auth,controller.uploadDiscountPic);
  ...
  app.get("/api/discount/getHotDiscount/:user_id", auth,controller.getHotDiscount);

  app.get(
    "/api/discount/getBrowseDiscount/:user_id",auth,
    controller.getBrowseDiscount
  );

  app.get("/api/discount/getMyDiscount/:user_id", auth,controller.getMyDiscount);

  app.get("/api/discount/displayPic/:discount_id",controller.displayPic);

  app.post("/api/discount/discountTransaction", auth,controller.discountTransaction);
};
