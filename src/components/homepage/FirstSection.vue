  ...
  <div>
    <div id="firstsection" class="section">
      ...
      <div class="page-container">
        ...
        <div>
          <div id="first_text">
            <h1 class="homepage-title">ARE YOU IN FRIENDZONE?</h1>
            <h2 class="homepage-description">
              If you're getting bored of being alone, Our community can help
              you.
            </h2>
          </div>
